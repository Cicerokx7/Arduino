...
//  Serial.print("go");
          ...
          if(distance > 5 && distance < 200 && alarm < 20){
            alarm = alarm+1;
          }
...
if(thyme == 10){
 ...
 ///   if (pixy.ccc.numBlocks){
  ...
  // power = map(spede, 0, 800, 255, 0)5
      if(spede < 200 && power < 245){
      power = power+10;
    }
  if(spede < 300 && power < 255){
    power = power+1;
  }
  if(spede > 300 && power > 0){
    power = power-1;
  }
  if(spede > 400 && power > 10){
    power = power-10;
  }
